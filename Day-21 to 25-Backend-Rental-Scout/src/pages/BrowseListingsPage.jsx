...
function BrowseListingsPage({ rentals, isLoading, error, onToggleSave, onRetry }) {
  ...
  const lowestRent = rentals.length
    ? Math.min(...rentals.map((rental) => rental.rentPerMonth))
    : 0
